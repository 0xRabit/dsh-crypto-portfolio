...
- **Author links + tip jar.** The settings footer carries the author's socials (X / Discord / GitHub) and a *Buy me a coffee* dialog with a tip.md badge and a Binance Pay QR — the badge is vendored locally, so the page still makes no third-party requests.
